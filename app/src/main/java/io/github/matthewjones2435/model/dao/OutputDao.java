...
/**
 *  interface for the Output data entity {@link Output} meant to insert and query the
 *  autogenerated id numbers once an output file has been created, as the application
 *  stands it is inoperable.
 */
